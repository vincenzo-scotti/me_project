...
SECRET_KEY = 'django-insecure-^!bl#@3o%0s1(yoi*b_*6kvnk(*5ml&m3)v)@&^f!tveb4zcp-'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), './home/templates/', './search/templates/', './chat/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
